defmodule ReadingLists.ListsTest do
  ...
  describe "lists" do
    ...
    @valid_attrs %{is_starred: true, title: "some title"}
    @update_attrs %{is_starred: false, title: "some updated title"}
